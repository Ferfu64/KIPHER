      ...
      <div className="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <button 
              onClick={() => triggerEvent('BLACKOUT', 1, 5, 'TOTAL_NETWORK_BLACKOUT')}
              className="flex flex-col items-center gap-2 p-4 bg-zinc-950 border border-white/10 hover:bg-zinc-900 transition-all group"
            >
              <Ghost className="text-white group-hover:opacity-100 opacity-50" />
              <span className="text-[10px] font-black uppercase tracking-tighter">BLACKOUT</span>
            </button>
          </div>
