...
export default function CommandCenter({ currentUser }: { currentUser: UserProfile }) {
  ...
  const CUTSCENE_OPTIONS = [
    ...
    { type: 'OLIVER_TRANSFORMATION', label: 'OLIVER_TRANSFORMATION (1 in 500)' },
    ...
    { type: 'GHOST_SIGNAL', label: 'GHOST_SIGNAL (1 in 500)' },
    { type: 'VOID_TREMOR', label: 'VOID_TREMOR (1 in 500)' },
    { type: 'CYBER_CORE', label: 'CYBER_CORE (1 in 500)' },
    { type: 'NEURAL_NEST', label: 'NEURAL_NEST (1 in 500)' },
    { type: 'STATIC_WAVE', label: 'STATIC_WAVE (1 in 500)' },
    { type: 'PIXEL_PRIME', label: 'PIXEL_PRIME (1 in 500)' },
    { type: 'DATA_DRAIN', label: 'DATA_DRAIN (1 in 500)' },
    { type: 'SHELL_SWITCH', label: 'SHELL_SWITCH (1 in 500)' },
    { type: 'LINK_LEAK', label: 'LINK_LEAK (1 in 500)' },
    { type: 'CHIP_CRUSH', label: 'CHIP_CRUSH (1 in 500)' },
    { type: 'WIRE_WARP', label: 'WIRE_WARP (1 in 500)' },
    { type: 'FLOW_FAULT', label: 'FLOW_FAULT (1 in 500)' },
  ];
